                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('discountes.create') }}" class="btn btn-info">
                                    ...
                                    <tbody class="text-center">
                                        @foreach ($discountes as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('discountes.show', $item->id) }}"
                                                ...
                                                <td class="justify-content-center d-flex">
                                                    ...
                                                    <a href="{{ route('discountes.edit', $item->id) }}"
                                                        class="btn btn-primary" style="margin-right: 10px;">
                                                        <i class="fa fa-edit"></i></a>

                                                    <form action="{{ route('discountes.destroy', $item->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
