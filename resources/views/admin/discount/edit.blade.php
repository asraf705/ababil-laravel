                ...
                <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ route('discountes.update', $item->id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 d-flex">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="number" name="percentage" class="form-control" value="{{ $item->percentage }}" placeholder="Amount" required>
                                            </div>
                                        </div>
                                    </div>
