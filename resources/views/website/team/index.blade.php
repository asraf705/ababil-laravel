                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="py-5 team4">
                        <div class="container">
                            ...
                            <div class="row">
                                <!-- column  -->
                                <div class="col-lg-3 mb-4 mt-15">
                                    <!-- Row -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <img src="https://asraf-profile.vercel.app/assets/img/about.png" alt="wrapkit"
                                            ...
                                            <div class="pt-2">
                                                ...
                                                <ul class="list-inline">
                                                    <li class="list-inline-item"><a href="#"
                                                            class="text-decoration-none d-block px-3"><i
                                ...
                                <div class="col-lg-3 mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <div class="pt-2">
                                                <h5 class="mt-4 font-weight-medium mb-0">Michael Doe2</h5>
                                                <h6 class="subtitle mb-3">Property Specialist</h6>
                                                <p>You can relay on our amazing features list and also our customer services
                                                    will be great experience.</p>
                                                <ul class="list-inline">
                                ...
                                <div class="col-lg-3 mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <div class="pt-2">
                                                <h5 class="mt-4 font-weight-medium mb-0">Michael Doe</h5>
                                                <h6 class="subtitle mb-3">Property Specialist23</h6>
                                                <p>You can relay on our amazing features list and also our customer services
                                                    will be great experience.</p>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item"><a href="#"
